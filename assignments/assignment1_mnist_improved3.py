# -*- coding: utf-8 -*-
"""
Created on Thu Feb  9 23:24:16 2017
    ...
    for epoch in range(training_epochs):
        ...
        for i in range(total_batch):
            ...
            if i % display_step == 0:
                ...
                "batch_index %4d/%4d, loss %.5f, training accuracy %.5f" % (i, total_batch, loss_value, train_accuracy))
                
    # Calculate accuracy for all mnist test images
    print("Test accuracy: %.5f" % accuracy.eval(
